...
\section{Observaci\'on abierta (por revisar)}
\noindent\fbox{\begin{minipage}{0.95\linewidth}\small
\textbf{Reparto del rodamiento plataforma/brazo.} En el Omni One, el anillo giratorio del brazo
y la plataforma parecen compartir el \emph{mismo rodamiento central}, con una base estructural que
sostiene la plataforma. Queda por confirmar: (i) si es un \'unico rodamiento de gran di\'ametro o
dos conc\'entricos; (ii) c\'omo se reparte ese rodamiento entre el \emph{giro} del brazo y el
\emph{soporte del peso} de la plataforma; (iii) c\'omo la base transmite el peso del usuario m\'as
el momento del brazo ($\sim$630~N\,m, Secci\'on~6) al piso. El modelo actual (collar giratorio +
base fija) es una aproximaci\'on \textbf{a validar}: impacta directamente el dise\~no del giro y el
an\'alisis de cargas.
\end{minipage}}
\vspace{4pt}
